...
namespace Playground2D.StationObject.StarPlasma
{
    public class StarPlasmaStation : Station
    {
        ...
        private void OnMouseDown()
        {
            if (_stationResourceExtraction != null && _resourceExtractionWindow != null)
            {
                OpenResourceExtractionWindow(
                    _stationResourceExtraction.items[1].nameStation,
                    _stationResourceExtraction.items[1].nameForm,
                    _stationResourceExtraction.items[1].price,
                    _stationResourceExtraction.items[1].icon
                );
            }
        }
