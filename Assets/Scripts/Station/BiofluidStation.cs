...
{
    public class BiofluidStation : Station
    {
            ...
            private void OnMouseDown()
            {
                if (_stationResourceExtraction != null && _resourceExtractionWindow != null)
                {
                    OpenResourceExtractionWindow(
                        _stationResourceExtraction.items[2].nameStation,
                        _stationResourceExtraction.items[2].nameForm,
                        _stationResourceExtraction.items[2].price,
                        _stationResourceExtraction.items[2].icon
                    );
                }
            }
